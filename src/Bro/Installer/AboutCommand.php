...
/**
 * This command provides information about the Symfony Bro installer.
 *
...
class AboutCommand extends Command
{
    ...
    protected function configure()
    {
        $this
            ->setName('about')
            ->setDescription('Bro Installer Help.')
        ;
    }
 ...
 This is the official Bro installer to start new projects based on the
